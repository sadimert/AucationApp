...
public class MyWishList extends ArrayAdapter<WishInformation> {

    private Activity Context;
    private List<WishInformation> WishList;

    public MyWishList(Activity Context, List<WishInformation> WishList){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (wishInformation.ImageDownloadLink.equals("NoImage") || wishInformation.ImageDownloadLink.length() <= 38 || !wishInformation.ImageDownloadLink.substring(0,38).equals("https://firebasestorage.googleapis.com")){
            Picasso.with(Context).load("https://firebasestorage.googleapis.com/v0/b/android-dayi.appspot.com/o/no_image.png?alt=media&token=b458f95f-68e7-42af-8b37-c3df9c9fa5ac").resize(200,200).placeholder(R.drawable.progress_animation).into(WishImage);
        }
        else {
